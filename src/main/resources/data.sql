...
insert into student(id, name) values (2001, 'Shoron');

insert into student(id, name) values (2002, 'Hasan');

insert into student(id, name) values (2003, 'Shaekh');
...
insert into review(id, rating, description) values (5003, '2', 'Not Good');
